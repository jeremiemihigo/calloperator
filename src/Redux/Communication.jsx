...
export const Readcommunication = createAsyncThunk(
  "communication/Readcommunication",
  async () => {
    try {
...
export const Ajoutercommunication = createAsyncThunk(
  "communication/Ajoutercommunication",
...
const zone = createSlice({
  ...
  extraReducers: {
    ...
    [UpdateCommunication.fulfilled]: (state, action) => {
      const newData = state.communication.map((x) =>
    ...
    [DeleteCommunication.fulfilled]: (state, action) => {
      const newData = state.communication.filter(
