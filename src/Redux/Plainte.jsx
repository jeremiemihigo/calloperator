...
export const ReadPlainte = createAsyncThunk("Plainte/ReadPlainte", async () => {
  try {
...
export const AjouterPlainte = createAsyncThunk(
  "Plainte/AjouterPlainte",
...
export const AddItemPlainte = createAsyncThunk(
  "Plainte/AddItemPlainte",
  async (data, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        lien_issue + "/itemPlainte",
        data,
        config
      );
      return response.data;
