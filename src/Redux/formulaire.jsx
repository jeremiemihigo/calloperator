...
export const ReadFormulaire = createAsyncThunk('formulaire/ReadFormulaire', async (id, { rejectWithValue }) => {
  try {
...
export const AjouterFormulaire = createAsyncThunk('formulaire/AjouterFormulaire', async (data, { rejectWithValue }) => {
  try {
    const response = await axios.post(portofolio + '/addFormulaire', data, config);
    return response.data;
  } catch (error) {
    return rejectWithValue(error.response.data);
  }
