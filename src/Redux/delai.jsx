...
export const Readdelai = createAsyncThunk('delai/Readdelai', async (id, { rejectWithValue }) => {
  try {
...
export const Ajouterdelai = createAsyncThunk('delai/Ajouterdelai', async (data, { rejectWithValue }) => {
  try {
