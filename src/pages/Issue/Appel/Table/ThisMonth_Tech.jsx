  ...
  React.useEffect(() => {
    if (data) {
      setGraphique({
        ...
        callcenter: data.filter(
          (x) => x.statut === "resolved_awaiting_confirmation"
        ),
      });
    }
  }, [data]);
    ...
    <>
        ...
        {data && (
          <>
            <Grid item lg={3} xs={12} sm={6} md={4} sx={{ padding: "2px" }}>
              <Paper
                onClick={(e) => openDataTech(e, "technicien")}
                elevation={3}
                sx={style.paper}
              >
                <div className="papierthismonth">
                  <div>
            ...
            <Grid item lg={3} xs={12} sm={6} md={4} sx={{ padding: "2px" }}>
              <Paper
                onClick={(e) => openDataTech(e, "encours")}
                elevation={3}
                sx={style.paper}
              >
                <div className="papierthismonth">
            ...
            <Grid item lg={3} xs={12} sm={6} md={4} sx={{ padding: "2px" }}>
              <Paper
                onClick={(e) => openDataTech(e, "callcenter")}
                elevation={3}
                sx={style.paper}
              >
                <div className="papierthismonth">
      ...
      <Paper elevation={2} sx={{ padding: "10px", margin: "10px" }}>
        <p style={{ padding: "0px", margin: "0px" }}>
          Technician with more intervention waiting
        </p>
      </Paper>
      <Grid container>
        {dataChart &&
          dataChart.map((index) => {
            return (
              ...
              >
                <Paper
                  className="paperNumber"
                  onClick={(e) => openDataTech(e, index.code)}
