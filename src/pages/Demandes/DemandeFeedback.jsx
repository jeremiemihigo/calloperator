    ...
    setFilterFn({
      fn: (items) => {
        if (target === "") {
          ...
          return items.filter(
            (x) =>
              x.idDemande.includes(e.target.value.toLowerCase()) ||
              x.codeAgent.includes(e.target.value.toUpperCase())
          );
        }
      },
    });
              ...
              >
                <div className="allP">
                  ...
                  <p style={{ fontSize: "9px", width: "100%" }}>
                    ...
                    <span style={{ float: "right" }}>
                      {moment(index.updatedAt).fromNow()}
                    </span>
                  </p>
                </div>
                ...
                {index?.typeVisit?.followup === "followup" && (
                  ...
                  >
                    ...
                    >
                      Ce client a déjà été en date du{" "}
...
export default React.memo(ListeDemandeFeedBack);
