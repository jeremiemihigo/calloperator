...
const Tech_value = Loadable(
  lazy(() => import("pages/Issue/Appel/Table/Technical"))
);
const Promesse_Payement = Loadable(
  lazy(() => import("pages/Rapport/Promesse_Payement"))
);
const IndexEdit = Loadable(
  lazy(() => import("pages/Issue/Appel/Component/IndexEdit"))
);
const Non_Technique = Loadable(
  lazy(() => import("pages/Issue/Appel/Table/N_Technical"))
);
const Renseignement = Loadable(
  lazy(() => import("pages/Rapport/Renseignement"))
);
